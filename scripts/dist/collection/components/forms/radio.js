...
export class List {
    ...
    render() {
        ...
        return (h("div", { class: "radio-wrapper" },
            h("div", { class: "input-label-container" },
                h("div", { class: "radio-container" },
                    h("input", { id: this.name, name: this.groupName, ref: el => this.itemRef = el, type: "radio", class: `
								form-radio
								form-radio-styled 
