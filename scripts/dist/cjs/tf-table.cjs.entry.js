...
const Table = class {
    ...
    render() {
        return [
            index.h("table", null, index.h("thead", null, this.headerCellData.map(cell => index.h("th", null, cell))), index.h("tbody", null, this.rowData.map(row => {
                return (index.h("tr", null, row.map(cell => index.h("td", { class: `table-cell bottom-border ${cell.textAlign == 'right' ? 'text-right' : ''}`, innerHTML: cell.body }))));
            })))
            // 	<div class="hide-slot">
