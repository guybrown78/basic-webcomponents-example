            ...
            h("div", { class: "login-body" },
                h("div", { class: "form-container" },
                    h("form", { onSubmit: this.onLogin.bind(this) },
                        h("tf-input", { name: "email", "input-type": "email", "input-required": true, label: "Email Address", ref: el => this.emailInputRef = el, value: this.values.email, onInput: this.onUserInput.bind(this), inputAutoComplete: "email" }),
                        h("tf-input", { name: "password", "input-type": "password", "input-required": true, label: "Password", ref: el => this.passwordInputRef = el, onInput: this.onUserInput.bind(this), inputAutoComplete: "on" }),
