import { Component, h, Prop, State, Watch, Method, Listen, Event } from '@stencil/core';
export class List {
    constructor() {
    ...
    render() {
        ...
        return (h("fieldset", { class: "radio-group-wrapper" },
            h("legend", { class: `${this.showLabel ? 'form-label' : 'form-label-sr-only'}` }, this.label),
            descriptionText,
            h("slot", null),
            bottomText));
    }
    static get is() { return "tf-radio-group"; }
    ...
    static get events() { return [{
            "method": "tfOnItemSelected",
            "name": "tfOnItemSelected",
            "bubbles": true,
            "cancelable": true,
            "composed": true,
            "docs": {
    ...
    static get listeners() { return [{
            "name": "tfOnRadioSelected",
            "method": "onHandleRadioSelected",
            "target": "body",
            "capture": false,
            "passive": false
        }]; }
