...
export class List {
    ...
    render() {
        ...
        if (this.showLeadingIcon) {
            leadingSVG = (h("div", { class: "tf-ld-svg-container tf-ld-svg-leading" },
                h(IconTag, { class: "tf-ld-svg-icon" })));
        }
        //
        if (this.showTrailingIcon) {
            trailingSVG = (h("div", { class: "tf-ld-svg-container tf-ld-svg-trailing" },
                h(IconTag, { class: "tf-ld-svg-icon" })));
        }
        else if (this.showErrorIcon) {
            trailingSVG = (h("div", { class: "tf-ld-svg-container tf-ld-svg-trailing" },
                h("tf-icon-exclamation", { class: "tf-ld-svg-error-icon" })));
        }
        //
        return (h("div", { class: "tf-ld-label-input-container" },
            h("label", { class: `${this.showLabel ? 'tf-ld-form-label' : 'tf-ld-form-label-sr-only'}`, htmlFor: this.name }, this.label),
            h("div", { class: "tf-ld-input-container" },
                leadingSVG,
    ...
    static get is() { return "tf-input-light-dom"; }
    static get originalStyleUrls() { return {
        "$": ["input-light-dom.scss"]
    }; }
