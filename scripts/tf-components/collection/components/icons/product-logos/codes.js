...
export const Bi = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const CM = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const MP = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const R3 = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const RP = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const Si = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const SM = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const T = (h("g", { fill: "currentColor", stroke: "currentColor", transform: "translate(55, 67)" },
...
export const TM = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export const VL = (h("g", { fill: "currentColor", stroke: "currentColor" },
    h("g", null,
...
export const VR = (h("g", { fill: "currentColor", stroke: "currentColor" },
...
export function getClientInitials(code) {
    if (!code) {
        return null;
    }
