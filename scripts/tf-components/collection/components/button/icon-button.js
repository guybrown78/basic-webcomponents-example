...
export class Button {
    ...
    render() {
        ...
        return (h("div", { class: `hex-container icon-btn-size-${this.size}` },
            h("button", { class: `hex-btn size-${this.size} colour-${this.colour} ${this.disabled ? 'disabled' : ''}`, type: this.buttonType, id: this.buttonId, disabled: this.disabled },
                icon,
                h("div", { class: `hexagon` },
