...
@Component({
  tag: 'tf-hexagon-svg',
  styleUrl: ' hexagon-svg.scss',
  shadow: true
})
export class HexagonSVG {
	@Prop({ reflect: true }) color: string = "accent";
	//
	@Prop({ reflect: true }) width: number = 45;
	@Prop({ reflect: true }) height: number = 51;
	//
	@Prop({ reflect: true }) size: string = "standard";
