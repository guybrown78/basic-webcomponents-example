...
var HexagonSVG = /** @class */ (function () {
    function HexagonSVG(hostRef) {
    ...
    Object.defineProperty(HexagonSVG, "style", {
        get: function () { return ":host{display:-ms-flexbox;display:flex}"; },
        enumerable: true,
        configurable: true
    });
    return HexagonSVG;
}());
export { HexagonSVG as tf_hexagon_svg };
