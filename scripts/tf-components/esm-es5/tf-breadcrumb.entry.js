...
var SideDrawerSubNavLink = /** @class */ (function () {
    ...
    SideDrawerSubNavLink.prototype.render = function () {
        var linkButton = (h("a", { href: this.hrefLink, title: !this.hrefTitle ? "Link to " + this.hrefLink : this.hrefTitle, class: "breadcrumb-link" }, h("span", { class: "breadcrumb-link-title" }, h("slot", null))));
        if (this.routerLink) {
            linkButton = (h("a", { onClick: this.onRouterLinkClicked.bind(this), title: !this.hrefTitle ? "Breadcrumb to " + this.hrefLink : this.hrefTitle, class: "breadcrumb-link" }, h("span", { class: "breadcrumb-link-title" }, h("slot", null))));
        }
        var chevronIcon = null;
        if (this.showChevron) {
            chevronIcon = (h("div", { class: "breadcrumb-space" }, h("tf-icon-chevron-right", { class: "chevron-right" })));
        }
        return (h("div", { class: "breadcrumb-wrapper" }, linkButton, chevronIcon));
    };
    return SideDrawerSubNavLink;
}());
SideDrawerSubNavLink.style = breadcrumbsCss;
export { SideDrawerSubNavLink as tf_breadcrumb };
