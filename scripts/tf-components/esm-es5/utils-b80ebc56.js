...
function getColourClassname(colour) {
    var className = colour === "white" ? "colour-white"
...
function getSVGColourClassname(colour) {
    var className = colour === "white" ? "svg-colour-white"
...
function getTrafficLightColourClassname(colour) {
    var className = colour === "red" ? "colour-red"
...
function getTextAlignClassname(textAlign) {
    var className = textAlign === "right" ? "text-align-right"
...
function getSizeClassname(size) {
    var className = size === "xl" || size === "extra-large" ? "size-xl"
...
function getIconSizeClassname(size) {
    var className = size === "xl" || size === "extra-large" ? "icon-size-xl"
...
function getIconBtnSizeClassname(size) {
    var className = size === "xl" || size === "extra-large" ? "icon-btn-size-xl"
...
function getPaddingClassname(padding) {
    var className = padding === "none" ? "padding-none"
        : "padding-default";
    return className;
}
// colour
//dd-link-
//dd-panel-
export { getColourClassname as a, getTextAlignClassname as b, getGridCountClassname as c, getTrafficLightColourClassname as d, getIconBtnSizeClassname as e, getSVGColourClassname as f, getPaddingClassname as g, getSizeClassname as h, getIconSizeClassname as i };
