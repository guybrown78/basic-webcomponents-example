...
var ATag = /** @class */ (function () {
    ...
    ATag.prototype.render = function () {
        return (h("a", { class: (this.underlined ? 'underlined' : 'not-underlined') + " tag-a color-" + this.colour + " text-align-" + this.textAlign + " ", href: this.url, target: this.target, title: this.tagTitle, tabindex: "0" }, h("slot", null)));
    };
    return ATag;
}());
