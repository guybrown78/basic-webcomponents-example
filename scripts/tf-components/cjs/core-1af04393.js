...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-1af04393.js', document.baseURI).href));
