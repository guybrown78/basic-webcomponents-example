...
const List = class {
    ...
    render() {
        let bottomText = null;
        if (this.showHint) {
            bottomText = index.h("p", { class: "tf-ld-hint" }, this.hint);
        }
        if (this.showError) {
            bottomText = index.h("p", { class: "tf-ld-error" }, this.errorMessage);
        }
        //
        let leadingSVG = null;
        ...
        if (this.showLeadingIcon) {
            leadingSVG = (index.h("div", { class: "tf-ld-svg-container tf-ld-svg-leading" }, index.h(IconTag, { class: "tf-ld-svg-icon" })));
        }
        //
        if (this.showTrailingIcon) {
            trailingSVG = (index.h("div", { class: "tf-ld-svg-container tf-ld-svg-trailing" }, index.h(IconTag, { class: "tf-ld-svg-icon" })));
        }
        else if (this.showErrorIcon) {
            trailingSVG = (index.h("div", { class: "tf-ld-svg-container tf-ld-svg-trailing" }, index.h("tf-icon-exclamation", { class: "tf-ld-svg-error-icon" })));
        }
        //
        return (index.h("div", { class: "tf-ld-label-input-container" }, index.h("label", { class: `${this.showLabel ? 'tf-ld-form-label' : 'tf-ld-form-label-sr-only'}`, htmlFor: this.name }, this.label), index.h("div", { class: "tf-ld-input-container" }, leadingSVG, index.h("input", { id: this.name, name: this.name, ref: el => this.itemRef = el, class: `
							tf-ld-form-input 
...
const StatDataCard = class {
    ...
    render() {
        const colour = this.colour;
        return (index.h("div", { class: "stat-card-container" }, index.h("div", { class: `
							stat-header
                ...
                : colour === "orange" || colour === "amber" ? "colour-amber"
                    : colour === "green" ? "colour-green"
                        : colour === "blue" ? "colour-blue"
                            : "colour-default"}
						` }, index.h("div", { class: "stat-header-title" }, index.h("slot", { name: "title" }))), index.h("div", { class: "stat-data" }, index.h("div", { class: `
								stat-data-content
								${colour === "red" ? "colour-red"
                : colour === "orange" || colour === "amber" ? "colour-amber"
                    : colour === "green" ? "colour-green"
...
const StatsPanel = class {
    ...
    render() {
        return (index.h("tf-card", { colour: "navy" }, index.h("div", { class: `
					stats-flex-box 
				` }, index.h("slot", null))));
    }
    get slotElement() { return index.getElement(this); }
...
exports.tf_input_light_dom = List;
