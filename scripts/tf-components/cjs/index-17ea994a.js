...
const NAMESPACE = 'transform-web-components';
    ...
    if ( (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if ( !styles.has(scopeId) && Cstr.style) {
            ...
            if ( cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await new Promise(function (resolve) { resolve(require('./shadow-css-931d5584.js')); }).then(m => m.scopeCss(style, scopeId, false));
            }
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-e400ffaf.js')); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "polyfills-dom" */ './dom-467ce1dc.js')); }).then(() => opts);
        }
    }
