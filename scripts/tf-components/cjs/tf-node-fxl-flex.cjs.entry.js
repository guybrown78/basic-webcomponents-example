...
const Node = class {
    ...
    render() {
        ...
        return (index.h("div", { id: "base-node", class: "base-node" }, index.h("div", { id: "fxl", class: "fxl", style: stylesL }, index.h("slot", { name: "fxl" })), index.h("div", { id: "flex", class: "flex" }, index.h("slot", { name: "flex" }))));
    }
};
Node.style = nodeFlexCss;

exports.tf_node_fxl_flex = Node;
