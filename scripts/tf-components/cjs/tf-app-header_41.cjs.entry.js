...
const List = class {
    ...
    render() {
        ...
        //
        return (core.h("div", { class: "label-input-container" }, core.h("label", { class: `${this.showLabel ? 'form-label' : 'form-label-sr-only'}`, htmlFor: this.name }, this.label), core.h("div", { class: "input-container" }, leadingSVG, core.h("input", { id: this.name, class: `
							form-input 
							form-input-styled 
