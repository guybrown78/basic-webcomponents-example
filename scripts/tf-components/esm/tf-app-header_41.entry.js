...
const List = class {
    ...
    render() {
        ...
        //
        return (h("div", { class: "label-input-container" }, h("label", { class: `${this.showLabel ? 'form-label' : 'form-label-sr-only'}`, htmlFor: this.name }, this.label), h("div", { class: "input-container" }, leadingSVG, h("input", { id: this.name, class: `
							form-input 
							form-input-styled 
						...
						`, placeholder: this.placeholder }), trailingSVG), bottomText));
    }
