...
const SideDrawerSubNavLink = class {
    ...
    render() {
        let linkButton = (h("a", { href: this.hrefLink, title: !this.hrefTitle ? `Link to ${this.hrefLink}` : this.hrefTitle, class: "breadcrumb-link" }, h("span", { class: "breadcrumb-link-title" }, h("slot", null))));
        if (this.routerLink) {
