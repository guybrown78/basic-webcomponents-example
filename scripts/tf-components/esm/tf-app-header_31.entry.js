import { r as registerInstance, c as createEvent, h, g as getElement } from './core-4955d2b1.js';
...
const Button = class {
    ...
    render() {
        ...
        return (h("span", null, h("button", { class: `tw-btn size-${this.size} colour-${this.colour}`, type: "button" }, (icon && (this.iconPosition == 'left' || this.iconPosition == 'default')) &&
...
const ChevronDown = class {
    ...
    render() {
        return (h("svg", { "aria-hidden": "true", focusable: "false", class: "svg-inline chevron-down w-14", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, h("path", { fill: "currentColor", d: "M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z" })));
    }
...
const ChevronUp = class {
    ...
    render() {
        return (h("svg", { "aria-hidden": "true", focusable: "false", class: "svg-inline chevron-up w-14", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, h("path", { fill: "currentColor", d: "M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z" })));
    }
    static get style() { return ".svg-inline{display:inline-block;font-size:inherit;height:1em;overflow:visible;vertical-align:-.125em;-webkit-transform-origin:center center;transform-origin:center center}.svg-inline.lg{vertical-align:-.225em}.svg-inline.w-1{width:.0625em}.svg-inline.w-2{width:.125em}.svg-inline.w-3{width:.1875em}.svg-inline.w-4{width:.25em}.svg-inline.w-5{width:.3125em}.svg-inline.w-6{width:.375em}.svg-inline-.w-7{width:.4375em}.svg-inline.w-8{width:.5em}.svg-inline.w-9{width:.5625em}.svg-inline.w-10{width:.625em}.svg-inline.w-11{width:.6875em}.svg-inline.w-12{width:.75em}.svg-inline.w-13{width:.8125em}.svg-inline.w-14{width:.875em}.svg-inline.w-15{width:.9375em}.svg-inline.w-16{width:1em}.svg-inline.w-17{width:1.0625em}.svg-inline.w-18{width:1.125em}.svg-inline.w-19{width:1.1875em}.svg-inline.w-20{width:1.25em}.svg-inline.pull-left{margin-right:.3em;width:auto}.svg-inline.pull-right{margin-left:.3em;width:auto}.svg-inline.border{height:1.5em}.svg-inline.li{width:2em}.svg-inline.fw{width:1.25em}"; }
};
...
*/
    ...
    render() {
        return (h("div", { id: "dropdown" }, h("button", { onClick: this.onMenuClicked.bind(this), id: "dropdown-btn", tabindex: "0", class: this.isOpenDelayed ? 'active' : '' }, h("span", { id: "title" }, "Actions"), h("span", { id: "icon" }, h("tf-icon-chevron-down", null))), h("div", { id: "dropdown-content", class: this.isOpen ? 'show' : '' }, h("button", { class: "dropdown-item-btn", id: "" }, h("span", { id: "title" }, "View")), h("button", { class: "dropdown-item-btn", id: "" }, h("span", { id: "title" }, "Assign to Course")), h("button", { class: "dropdown-item-btn", id: "" }, h("span", { id: "title" }, "Assign to Cattegory")), h("button", { class: "dropdown-item-btn", id: "" }, h("span", { id: "title" }, "Remove")))));
    }
...
const Table = class {
    ...
    render() {
        return [
            h("div", { class: "div-1" }, h("div", { class: "div-2" }, h("div", { class: "div-3" }, h("table", null, h("thead", null, this.headerCellData.map(cell => h("th", null, cell))), h("tbody", null, this.rowData.map(row => {
