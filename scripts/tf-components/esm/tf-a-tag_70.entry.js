...
const LoginForm = class {
    ...
    render() {
        ...
        return (h("div", { class: "login-container" }, h("div", { class: "login-header" }, h("h2", { class: "header-2" }, "Login")), h("div", { class: "login-body" }, h("div", { class: "form-container" }, h("form", { onSubmit: this.onLogin.bind(this) }, h("tf-input", { name: "email", "input-type": "email", "item-required": true, label: "Email Address", ref: el => this.emailInputRef = el, "input-value": this.values.email, onInput: this.onUserInput.bind(this), autoComplete: "email" }), h("tf-input", { name: "password", "input-type": "password", "item-required": true, label: "Password", ref: el => this.passwordInputRef = el, onInput: this.onUserInput.bind(this), autoComplete: "on" }), h("div", { class: "login-footer" }, h("div", { class: "link-container" }, forgotten), h("tf-button", { colour: "aqua", disabled: !this.formValid || this.loading, "button-type": "submit" }, "Login")))))));
    }
};
