...
const List = class {
    ...
    render() {
        ...
        //
        return (h("div", { class: "label-input-container" }, h("label", { class: `${this.showLabel ? 'form-label' : 'form-label-sr-only'}`, htmlFor: this.name }, this.label), h("div", { class: "input-container" }, leadingSVG, h("input", { id: this.name, ref: el => this.inputRef = el, class: `
							form-input 
							form-input-styled 
...
const LoginForm = class {
    ...
    render() {
        ...
        return (h("div", { class: "login-container" }, h("div", { class: "login-header" }, h("h2", null, "Login")), h("div", { class: "login-body" }, h("div", { class: "form-container" }, h("form", { onSubmit: this.onLogin.bind(this) }, h("tf-input", { name: "email", "input-type": "email", "input-required": true, label: "Email Address", ref: el => this.emailInputRef = el, value: this.values.email, onInput: this.onUserInput.bind(this), inputAutoComplete: "email" }), h("tf-input", { name: "password", "input-type": "password", "input-required": true, label: "Password", ref: el => this.passwordInputRef = el, onInput: this.onUserInput.bind(this), inputAutoComplete: "on" }), h("div", { class: "login-footer" }, h("div", { class: "link-container" }, forgotten), h("tf-button", { colour: "aqua", disabled: !this.formValid || this.loading, "button-type": "submit" }, "Login")))))));
    }
